...
public class CategoryListFragment extends Fragment implements ParentFragmentInterface
{
    Activity activity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        if(getChildFragmentManager().getBackStackEntryCount() == 0) {
            // Add new fragment
            CategorySelectStateFragment selectStateFragment = new CategorySelectStateFragment();
