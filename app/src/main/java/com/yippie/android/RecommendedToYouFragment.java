 ...
 */
public class RecommendedToYouFragment extends Fragment implements View.OnClickListener
{
     ...
     * Constructor
     */
    public RecommendedToYouFragment(){}
    ...
    private class RecomendedListAdapter extends BaseAdapter
    {
        ...
        public ShopInfo getShopInfo(int position)
        {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            ShopInfo curShop = getShopInfo(position);


            // Update Shop info here
            holder.shopName.setText("Recommended To You " + String.valueOf(position));
